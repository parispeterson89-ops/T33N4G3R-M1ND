...
Pathlist = ['/wp-cron.php?ac=3', '/.well-known/wp-cron.php?ac=3', '/.well-known/acme-challenge/wp-cron.php?ac=3', '/wp-admin/wp-cron.php?ac=3', '/wp-includes/wp-cron.php?ac=3', '/wp-content/wp-cron.php?ac=3', '/wp-content/plugins/wp-cron.php?ac=3', '/wp-content/themes/wp-cron.php?ac=3']
class EvaiLCode:
	def __init__(self):
	...
	def checker(self, site):
		try:
			...
			for Path in Pathlist:
				...
				if('<title>Get S.H.E.L.L.en v1.0 | BY ..</title>' in check):
